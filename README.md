...
손끝으로 두드려 **10**을 만드는 퍼즐. Monument Valley 같은 조용한 파스텔 화면. 웹(TypeScript)으로 만들고 Capacitor로 감싸서 Google Play에 올립니다.
...
스토리는 전 20 스테이지, 5개씩 4챕터. 보드가 9×6(54칸)에서 9×11(99칸)까지 커지는데 **별 기준은 거의 그대로**라, 같은 별을 받으려면 갈수록 정확해야 합니다. 챕터의 마지막 스테이지를 깨면 캐릭터가 나오는 스토리 장면이 재생됩니다.
...
| [WORKLOG.md](./docs/WORKLOG.md) | **언제 무엇을 왜 바꿨는지.** 사람과 AI 도구가 같이 쓰는 기록 |
