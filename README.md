...
스토리는 전 **99 스테이지**, 9개씩 11챕터. 판 뒤에는 그림 한 장이 숨어 있고, 블록을 지우면 그 칸이 투명해지며 그림이 드러납니다. **전부 지우면 그림을 얻어 갤러리에 모읍니다** — 99장이 목표입니다. 모든 판은 전부 지울 수 있게 깔리므로, 막히면 운이 아니라 한 수를 잘못 둔 겁니다.
